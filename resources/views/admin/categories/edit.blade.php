                                ...
                                <div class="form-element col-sm-10">
                                    <select name="parent_id" class="form-control">
                                        ...
                                        @if (!empty(old('parent_id')))
                                            @include('admin.layouts.options', ['options' => $categories, 'selected' => old('parent_id'), 'label' => ''])
                                        @else
                                            @include('admin.layouts.options', ['options' => $categories, 'selected' => $category->parent_id, 'label' => ''])
                                        @endif
                                    </select>
                                </div>
                            </div>
